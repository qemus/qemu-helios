...
This build also includes an enhanced [SVGA](https://github.com/qemus/qemu-vmvga) implementation to improve performance for Windows XP and below, as they do not support GPU acceleration via Helios. It adds a `vmware-svga` device with 2D acceleration and  Direct3D support.
